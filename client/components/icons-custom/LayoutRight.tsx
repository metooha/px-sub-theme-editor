...
export function LayoutRight(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <rect x="14" y="3" width="8" height="2" rx="0.5" fill="currentColor" />
      <rect x="14" y="7" width="6" height="1" rx="0.5" fill="currentColor" opacity="0.5" />
